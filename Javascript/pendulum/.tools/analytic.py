...
if __name__ == '__main__':
    ...
    extensions = ['.html', '.js']  # Danh sách các phần mở rộng tệp
    filenames = ['pom.xml', 'Dockerfile']  # Danh sách các tên tệp cụ thể
    exclude_dirs = ['node_modules']  # Thư mục cần bỏ qua
    exclude_files = ['package-lock.json','launch.json']  # Tệp cần bỏ qua
